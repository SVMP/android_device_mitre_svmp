...
.PHONY: svmp_system_disk svmp_data_disk
...
#$(SVMP_DATA_DISK_IMAGE_TARGET): $(TARGET_DEVICE_DIR)/image_build/data-disk-blanks/android_data_disk_4G.img.tar.gz
#	@echo "Decompressing SVMP user data disk image: $@"
#	@rm -f $@
#	@echo $(hide) tar xzf $< -C $(PRODUCT_OUT)
#	@echo $(hide) mv $(PRODUCT_OUT)/android_data_disk_4G.img $(PRODUCT_OUT)/svmp_data_disk.img
#	$(hide) tar xzf $< -C $(PRODUCT_OUT)
#	$(hide) mv $(PRODUCT_OUT)/android_data_disk_4G.img $(PRODUCT_OUT)/svmp_data_disk.img
#	@echo "Done with SVMP user data disk image -[ $@ ]-"
